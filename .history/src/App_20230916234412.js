  ...
  return (
    <div className="App container mt-5">
      ...
      <div className="border bg-secondary text-white p-3 mb-4">
        <div className="mb-3">
          <div className="row">
            ...
            <div className="col-md-3">
              <button className="btn btn-info text-white" onClick={handleSearch}>SEARCH</button>
            </div>
          </div>
        </div>
              ...
              <tr key={user.id}>
                ...
                <td>
                  {editingUser === user.id ? (
                    ...
                    <>
                      <button className="btn text-primary mx-3" onClick={() => setEditingUser(user.id)}>UPDATE</button>
        ...
        <button className="btn text-secondary text-white mt-3" onClick={() => setShowCreateForm(!showCreateForm)}>
