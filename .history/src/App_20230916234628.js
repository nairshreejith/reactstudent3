...
function App() {
  ...
  return (
    <div className="App container mt-5">
      ...
      <div className="border bg-light text-white p-3 mb-4">
        <div className="mb-3">
          <div className="row">
            <div className="col-md-9">
              <input type="text" className="form-control" placeholder="Search by First Name or Email of User" value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} />
            </div>
            <div className="col-md-3">
              <button className="btn bg-white" onClick={handleSearch}>SEARCH</button>
            </div>
          </div>
        </div>
        <h2>Data of All the Users in the portal</h2>
              ...
              <tr key={user.id}>
                ...
                <td>
                  {editingUser === user.id ? (
                    ...
                    <>
                      <button className="btn bg-info mx-3" onClick={() => setEditingUser(user.id)}>UPDATE</button>
        ...
        <button className="btn bg-dark text-white mt-3" onClick={() => setShowCreateForm(!showCreateForm)}>
          ...
          <div class="mt-5">
            ...
            <div className="row">
              ...
              <div className="mb-4 p-3">
                <button className="btn bg-success text-white" onClick={handleCreateUser}>CREATE</button>
              </div>
            </div>
          </div>
        )}
